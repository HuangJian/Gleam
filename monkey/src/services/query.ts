...
// Re-export the shared query language (single source of truth in @gleam/shared/query).
...
export {
  ...
  QueryParseError,
  getSourceHost,
} from '@gleam/shared/query'
export type { QueryNode } from '@gleam/shared/query'
...
export class QueryService {
  ...
  public async query(input: string): Promise<import('@gleam/shared/types').Gleam[]> {
