...
export class CaptureService {
  ...
  public async capture(
    ...
    const sourceUrl = customSource?.url || (typeof window !== 'undefined' ? window.location.href : undefined);
    const sourceTitle = customSource?.title || (typeof document !== 'undefined' ? document.title : undefined);
